package com.skymall.interctpor;
...
public class LogInterceptor extends HandlerInterceptorAdapter {
    ...
    private StringBuilder getRequestInfo(HttpServletRequest request) {
        ...
        //reqInfo.append(" 来源IP=" + HttpUtil.getIpPortFormURL(request));


        String userName = "";
        try {
            Admin admin = (Admin) SecurityUtils.getSubject().getSession().getAttribute(Admin.CURRENT_USER);
            if (admin != null) {
...
//        reqInfo.append(" 请求参数=" + HttpUtil.getParameters(request).toString());
        return reqInfo;
    }
}
